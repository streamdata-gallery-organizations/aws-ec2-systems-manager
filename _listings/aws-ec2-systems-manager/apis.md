...
- name: Amazon EC2 Systems Manager API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/aws-ec2-systems-manager/master/_listings/aws-ec2-systems-manager/action-updatepatchbaseline-get.md
x-common:
